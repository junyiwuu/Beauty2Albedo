...
class MarigoldTrainer:
    def __init__(
        ...
        self.model: MaterialPipeline = model
        self.device = device
        ...
        self.model._encode_empty_text()
        self.empty_text_embed = self.model.empty_text_embed.detach().clone().to(device)

        self.model.unet.enable_xformers_memory_efficient_attention()

        # Trainability
        self.model.vae_albedo.requires_grad_(False)
        self.model.vae_beauty.requires_grad_(False)
        ...
        ######### add
        self.training_noise_scheduler.config.prediction_type = "epsilon"
    ...
    #     depth_latent = self.model._encode_rgb(stacked)
    #     return depth_latent
